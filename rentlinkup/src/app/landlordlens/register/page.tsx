        ...
        <div className="mx-auto max-w-md w-full rounded-lg border border-gray-200 bg-white shadow-sm overflow-hidden">
          <div className="p-6 space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-black">| LandlordLens</span>
            </div>
            <h1 className="text-2xl font-bold mt-4">Create an account</h1>
            <p className="text-sm text-gray-500">Get started with LandlordLens to manage your properties</p>
          </div>
          ...
          <div className="p-6 flex flex-col gap-4 border-t border-gray-200">
            <div className="text-sm text-center text-gray-500">
              ...
              <Link href="/landlordlens/login" className="text-black underline-offset-4 hover:underline">
                Sign in
              </Link>
            </div>
